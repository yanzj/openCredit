package org.fisco.bcos.web3sdk;
...
//     static gas provider
    public static final ContractGasProvider gasProvider = new ContractGasProvider() {
        ...
        public BigInteger getGasPrice(String contractFunc) {
            return OpenCreditConstants.GAS_PRICE;
        }
        ...
        public BigInteger getGasLimit(String contractFunc) {
            return OpenCreditConstants.GAS_LIMIT;
        }
     ...
     * @return Web3j
     */
    public static Web3j initWeb3j(Long groupId, FiscoConfig fiscoConfig) throws Exception {
        ...
        try {
            ...
            channelConnections.setCaCertPath("classpath:" + fiscoConfig.getCaCrtPath());
            channelConnections.setNodeCaPath("classpath:" + fiscoConfig.getNodeCrtPath());
            channelConnections.setNodeKeyPath("classpath:" + fiscoConfig.getNodeKeyPath());
            ...
            pool.setBeanName("web3sdk-" + groupId);
    ...
    public static Contract loadContract(String contractAddress, Web3j web3j, Credentials credentials, Class<?> cls) {
        ...
        try {
            ...
            Object contract = method.invoke(null,
                    ...
                    web3j,
                    credentials,
                    OpenCreditConstants.GAS_PRICE,
                    OpenCreditConstants.GAS_LIMIT);
...
//            TopicData topicData = f1.sendAsync().get(OpenCreditConstants.DEFAULT_DEPLOY_CONTRACTS_TIMEOUT_IN_SECONDS, TimeUnit.SECONDS);
//
//            log.info("topic data contract address: {}", topicData.getContractAddress());
//            if (topicData.getContractAddress().equals(OpenCreditConstants.ADDRESS_EMPTY)) {
...
//            TopicController topicController = f2.sendAsync().get(OpenCreditConstants.DEFAULT_DEPLOY_CONTRACTS_TIMEOUT_IN_SECONDS, TimeUnit.SECONDS);
//
//            log.info("topic control contract address: {}", topicController.getContractAddress());
//            if (topicController.getContractAddress().equals(OpenCreditConstants.ADDRESS_EMPTY)) {
...
//    }
    ...
    public static Long getBlockHeight(Web3j web3j) throws BrokerException {
        try {
            BlockNumber blockNumber = web3j.getBlockNumber().sendAsync().get(OpenCreditConstants.TRANSACTION_RECEIPT_TIMEOUT, TimeUnit.SECONDS);
...
//                    .sendAsync().get(OpenCreditConstants.TRANSACTION_RECEIPT_TIMEOUT, TimeUnit.SECONDS);
